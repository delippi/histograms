...
if(count_s>0 and count_l>0 and count_o>0):
   ...
   plt.plot(x_series,y_series_long,color=colors[1],linewidth=3,linestyle=linestyles[1],label='long ({})'.format(y_sum_long))
   plt.plot(x_series,y_series_ops,color=colors[2],linewidth=3,linestyle=linestyles[2],label='ops ({})'.format(y_sum_ops))
