...
!theia - path="/scratch4/NCEPDEV/fv3-cam/noscrub/Donald.E.Lippi/hrlyGDAS/" !base path of bufr files.
!theia - path2="/scratch3/BMC/gsienkf/whitaker/hrlygdas/rotdir/"
path="/scratch2/NCEPDEV/fv3-cam/Donald.E.Lippi/hrlyGDAS/" !base path of bufr files.
path2="/scratch2/BMC/gsienkf/whitaker/hrlygdas/rotdir/"
